...
# Created Time: Tue Apr 24 13:57:19 2018
...
class WordToPDF(object):
    def get_word_path(self, folder_path):
        '''
    ...
    def create_pdf_path(self, folder_path, save_path):
        '''
    ...
    def word2pdf(self, src_path, dst_path):
        '''
            定义一个h将word转换为pdf的函数
        '''
